...
from app.resources.bucketlist import (CreateBucketList,
                                      SingleBucketList,
                                      AllBucketList, BucketListEdit)
...
api.add_resource(EditBucketListItem,
                 '/v1/bucketlists/<int:bucket_id>/item/<int:item_id>')
